...
RUN axel http://nuls-usa-west.oss-us-west-1.aliyuncs.com/1.1.6/NULS-Wallet-linux64-1.1.6.tar.gz

RUN tar zxf NULS-Wallet-linux64-1.1.6.tar.gz
RUN rm NULS-Wallet-linux64-1.1.6.tar.gz
