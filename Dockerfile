...
RUN axel https://nuls-usa-west.oss-us-west-1.aliyuncs.com/1.0.2/NULS-Wallet-linux64-1.0.2.tar.gz

RUN tar zxf NULS-Wallet-linux64-1.0.2.tar.gz
RUN rm NULS-Wallet-linux64-1.0.2.tar.gz
